  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-white text-black mt-14 -mb-60 px-10 py-10 rounded-lg shadow-lg relative z-10"
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 px-7 py-10 gap-14">
          ...
          <div
            ...
            className="bg-white text-gray-800 rounded-lg shadow-lg flex flex-col  "
          >
            <div className="px-14 pb-10 pt-10">
